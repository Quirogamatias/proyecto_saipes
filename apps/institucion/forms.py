...
class MateriaForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields['id_horario'].queryset = Horario.objects.filter(estado = True,activo = True)
...
class Materia2Form(forms.ModelForm):
...
class FechaForm(forms.ModelForm):
    ...
    class Meta:
        model = Fecha
        fields = ['fecha_evento','tipo_evento','evento']
        labels = {
...
class PromedioNotasTotalForm(forms.ModelForm):
