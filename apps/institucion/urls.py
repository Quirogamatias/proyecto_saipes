...
urlpatterns = [
    ...
    path('inicio_inscripcion_alumno/',InicioInscripcionAlumno.as_view(), name = 'inicio_inscripcion_alumno'),
    ...
    path('inicio_promedionotastotal/',InicioPromedioNotasTotal.as_view(), name = 'inicio_promedionotastotal'),
    ...
    path('crear_inscripcion_alumno/',login_required(CrearInscripcionAlumno.as_view()), name = 'crear_inscripcion_alumno'),
    ...
    path('listar_inscripciones_alumno/',login_required(ListadoInscripcionesAlumno.as_view()),name = 'listado_inscripciones_alumno'),
    ...
    path('listar_promediost/',login_required(ListadoPromedioTotal.as_view()),name = 'listado_promediost'),
    ...
    path('eliminar_inscripcion_alumno/<int:pk>/',login_required(EliminarInscripcionAlumno.as_view()),name = 'eliminar_inscripcion_alumno'),
    ...
    path('detalle_inscripcion_alumno/<int:pk>/',login_required(DetalleInscripcionAlumno.as_view()), name = 'detalle_inscripcion_alumno'),
